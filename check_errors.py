...
# Error thrown if all 500 reps have not been completed for this bin        
    ...
    v_file = "/Data/vimosindi/analysis/%s/results/%sgal_vel_uncert_check.dat" % (
        galaxy, wav_range)
    s_file = "/Data/vimosindi/analysis/%s/results/%sgal_sigma_uncert_check.dat" % (
        galaxy, wav_range)
    h3_file = "/Data/vimosindi/analysis/%s/results/%sgal_h3_uncert_check.dat" % (
        galaxy, wav_range)
    h4_file = "/Data/vimosindi/analysis/%s/results/%sgal_h4_uncert_check.dat" % (
        galaxy, wav_range)
