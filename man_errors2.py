...
# ------------====== Reading Files and calc std_devs ==========----------
	for i, componant in enumerate(componants):
		...
		v_file = output_dir + "gal_" + componant + "_vel.dat"
		s_file = output_dir + "gal_" + componant + "_sigma.dat"
		h3_file = output_dir + "gal_" + componant + "_h3.dat"
		h4_file = output_dir + "gal_" + componant + "_h4.dat"
